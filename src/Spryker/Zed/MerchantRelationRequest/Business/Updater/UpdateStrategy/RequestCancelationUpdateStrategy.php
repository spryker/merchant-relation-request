...
class RequestCancelationUpdateStrategy implements MerchantRelationRequestUpdaterStrategyInterface
{
    /**
    ...
    {
        return $merchantRelationRequestTransfer->getStatusOrFail() === SharedMerchantRelationRequestConfig::STATUS_CANCELED;
    }
    ...
    public function execute(
        ...
        foreach ($this->merchantRelationRequestConfig->getModifiableFieldsAllowedForCancelation() as $allowedField) {
